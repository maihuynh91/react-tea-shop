...
export default function Shipping() {
  return (
    <div className="row">
      ...
      <h4> Shipping Method:  UPS . Usually within 1-2 business days – and it can take between 3 and 7 days for your product to reach you. </h4>
      <br/>
      <h3>International shipping</h3>
      <h4> Shipping costs are $11.00 flat rate for all orders. </h4>
      <h4>Shipping Method: USPS (Priority Mail International). Delivery may take up to 10 days. </h4>
      <hr/>
